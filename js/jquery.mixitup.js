! function(t, e) {
    ...
    t.MixItUp = function() {
        ...
        _filters: {},
        extend: function(e) {
            for (var a in e) t.MixItUp.prototype[a] = e[a]
        },
        ...
        _init: function(e, a) {
            ...
            if (i._execAction("_init", 0, arguments), a && t.extend(!0, i, a), i._$body = t("body"), i._domNode = e, i._$container = t(e), i._$container.addClass(i.layout.containerClass), i._id = e.id, i._platformDetect(), i._brake = i._getPrefixedCSS("transition", "none"), i._refresh(!0), i._$parent = i._$targets.parent().length ? i._$targets.parent() : i._$container, i.load.sort && (i._newSort = i._parseSort(i.load.sort), i._newSortString = i.load.sort, i._activeSort = i.load.sort, i._sort(), i._printSort()), i._activeFilter = "all" === i.load.filter ? i.selectors.target : "none" === i.load.filter ? "" : i.load.filter, i.controls.enable && i._bindHandlers(), i.controls.toggleFilterButtons) {
                i._buildToggleArray();
                for (var n = 0; n < i._toggleArray.length; n++) i._updateControls({
        ...
        _updateControls: function(a, i) {
            ...
            for (var c = 0; 2 > c; c++) l = n.controls.live ? t(n.selectors[s]) : n["_$" + s + "Buttons"], l && o(l, "[data-" + s + '="' + r[s] + '"]'), s = "sort";
        ...
        _getTargetData: function(t, e) {
            var a, i = this;
            t.dataset[e + "PosX"] = t.offsetLeft, t.dataset[e + "PosY"] = t.offsetTop, i.animation.animateResizeTargets && (a = i._suckMode ? {
                marginBottom: "",
                marginRight: ""
        ...
        _bindTargetDone: function(e) {
            ...
            a._execAction("_bindTargetDone", 0, arguments), i.dataset.bound || (i.dataset.bound = !0, a._targetsBound++, e.on("webkitTransitionEnd.mixItUp transitionend.mixItUp", function(n) {
                (n.originalEvent.propertyName.indexOf("transform") > -1 || n.originalEvent.propertyName.indexOf("opacity") > -1) && t(n.originalEvent.target).is(a.selectors.target) && (e.off(".mixItUp"), i.dataset.bound = "", a._targetDone())
        ...
        _getPrefixedCSS: function(t, e, a) {
            var i = this,
                ...
                r = "",
                o = -1;
            for (o = 0; 2 > o; o++) r = 0 === o ? i._prefix : "", a ? n[r + t] = r + e : n[r + t] = e;
            return i._execFilter("_getPrefixedCSS", n, arguments)
        },
        ...
        getOption: function(t) {
            var a = this,
                i = function(t, a) {
                    for (var i = a.split("."), n = i.pop(), r = i.length, o = 1, s = i[0] || a;
                        (t = t[s]) && r > o;) s = i[o], o++;
        ...
        destroy: function(e) {
            ...
            a._execAction("destroy", 1, arguments), i[a.selectors.filter] && i[a.selectors.filter] > 1 ? i[a.selectors.filter]-- : 1 === i[a.selectors.filter] && delete i[a.selectors.filter], n[a.selectors.sort] && n[a.selectors.sort] > 1 ? n[a.selectors.sort]-- : 1 === n[a.selectors.sort] && delete n[a.selectors.sort], delete t.MixItUp.prototype._instances[a._id]
        }
        ...
        return i = i ? i : "", this.each(function() {
            for (var n = this, r = a.split(" "), o = 0; o < r.length; o++)
                for (var s = 0; 4 > s; s++) {
                    ...
                    if (n.style[l] !== e && "unknown" != typeof n.style[l] && n.style[l].length > 0 && (n.style[l] = ""), !i && 1 === s) break
                }
